...
async function main() {
  ...
  const propertyA = await prisma.property.upsert({
    ...
    update: {
      ...
      name: "Nhà trọ Bình Thạnh A",
      address: "12 Nguyễn Hữu Cảnh, Bình Thạnh, Hồ Chí Minh",
      description: "Khu trọ gần trung tâm, phù hợp sinh viên và nhân viên văn phòng.",
      status: "ACTIVE",
      latitude: "10.7920000",
  ...
  const propertyB = await prisma.property.upsert({
    ...
    update: {
      ...
      name: "Căn hộ mini Quận 7 B",
      address: "88 Nguyễn Thị Thập, Quận 7, Hồ Chí Minh",
      description: "Căn hộ mini gần khu văn phòng Quận 7.",
      status: "ACTIVE",
      latitude: "10.7390000",
  ...
  const propertyC = await prisma.property.upsert({
    ...
    update: {
      landlordId: approvedLandlord.id,
      regionId: binhThanh.id,
      name: "Studio Bình Thạnh C",
      address: "45 Xô Viết Nghệ Tĩnh, Bình Thạnh, Hồ Chí Minh",
      description: "Studio mới, có gác và cửa sổ thoáng.",
      status: "ACTIVE",
      latitude: "10.8070000",
